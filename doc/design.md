...
--------------------------------------------------------
* **บัญชีผู้ใช้ (User Profile):** ผู้ใช้สามารถทำการย้ายทะเบียน , เปลี่ยนแปลงข้อมูล , เปลี่ยนเจ้าของบ้าน และ ขอทะเบียนใหม่ได้ และยังทำหน้าที่เป็น User Interface (ส่วนติดต่อกับผู้ใช้)
* **บัญชีเจ้าหน้าที่(Officer Profile):** เจ้าหน้าที่สามารถดูคำร้องจากฐานข้อมูลคำร้อง และดำเนินการได้ และยังเป็น Officer Interface(ส่วนติดต่อกับเจ้าหน้าที่)
* 
